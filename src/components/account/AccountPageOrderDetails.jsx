...
function AccountPageOrderDetails(props) {
    ...
    const doHandleCancelOrder = (orderId) => {
        Swal.fire({
    ...
    const doHandleProcessToPayment = () => {
        return new Promise((resolve) => {
            Swal.fire({
                // title: "Anda yakin?",
                text: "Dengan menekan tombol ok, anda telah menyetujui menerima barang sesuai eBAST.",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
    ...
    if (state.transactionDetail === null) {
        ...
        content = (
            <>
                                ...
                                <div className="col-md-6 px-2 mt-2">
                                    <AsyncAction
                                        ...
                                        render={({ run, loading }) => (
                                            ...
                                            >
                                                Buat eBAST (Berita Acara Serah Terima)
                                            </button>
                                        )}
                                    />
                                </div>
                ...
                <Modal isOpen={modal['reason']} centered toggle={() => doOpen('reason')}>
                    <ModalHeader>
                    ...
                    <ModalBody>
                        ...
                        <div className='d-flex justify-content-end w-100'>
                            <button type="button" class="btn btn-secondary mr-1" onClick={() => doOpen('reason')}>Batal</button>
