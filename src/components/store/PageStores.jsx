...
const Stores = (props) => {
    ...
    */
    ...
    const doChangeKeywordValue = (e) => {
        ...
        if (value !== "") {
            dispatch({ type: SET_SEARCH_VALUE, keyword: value });
        } else {
            dispatch({ type: SET_SEARCH_VALUE, keyword: undefined });
        }
    };
                            ...
                            >
                                <div className="card-body p-0">
                                    ...
                                    <p className="card-text">
                                        ...
                                        menyediakan dan melayani sekolah yang melakukan pemesanan pada sistem SIPLah sesuai
                                        dengan kebijakan yang berlaku. Penyedia tunduk pada kebijakan produk maupun
                                        kebijakan privasi. Total Penyedia berasal dari penyedia yang sudah dinyatakan
                                        lengkap persyaratan (proses Approve) menjadi penyedia SIPLah Kemdikbud Eureka.
                                    </p>
                                </div>
                            </div>
                        </div>
