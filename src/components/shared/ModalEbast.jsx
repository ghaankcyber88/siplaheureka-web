            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div className="row my-3">
                        <div className="col-12">
                            <small className="text-muted">
                                <span className="text-danger">*</span>Berikan DENDA jika pengiriman penyedia terlalu
                                lama
                            </small>
                   ...
                   */}
                    ...
                    <p>
                    <input type="radio" onChange={e =>setCekList(!cekList)} class="form-check-input"   />Dengan ini Satuan Pendidikan menyatakan bahwa pesanan telah sesuai dan <b>FINAL</b> sehingga BAST dapat dicetak atas pesanan ini.
                    </p>
                    {isSendEbast && (
                        <div className="row">
                            { cekList === true ?
                                ...
                                >
                                    <AsyncAction
                                        ...
                                        render={({ run, loading }) => (
                                            ...
                                            >
                                                {historyEbastSelected.length > 0 ? "Update" : "Simpan"} eBAST
                                            </button>
                                        )}
                                    />
                                </div>
