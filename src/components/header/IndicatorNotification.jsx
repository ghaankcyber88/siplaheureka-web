...
function IndicatorCart(props) {
    ...
    if (notification?.items?.length > 0 || notificationReminder?.items?.length > 0) {
        const items = notification?.items?.map((item) => {
            ...
            if (item.icon) {
                image = (
                    <div className="product-image dropcart__product-image d-flex justify-content-center align-items-center" style={{ width: '45px', height: '50px' }}>
            ...
            return (
                <div key={item.id} onClick={() => handleRedirect(item)} className="dropcart__product my-1" style={!item.isRead
                    ? {
                    ...
                    <div className="dropcart__product-info">
                        <div className="dropcart__product-name d-flex justify-content-between flex-column" style={{ fontSize: '12px', height: '100%' }}>
                            <span className="font-weight-bold mb-1" style={{
                                overflowY: 'hidden',
                            ...
                            <span dangerouslySetInnerHTML={{ __html: item.text }} style={{
                                overflowY: 'hidden',
                                textOverflow: 'ellipsis',
                                width: '100%',
                                overflowX: 'hidden',
        ...
        dropdown = (
            <div className="dropcart" style={{ overflowY: 'auto', maxHeight: '400px' }}>
                ...
                <div style={{ padding: '5px 10px', marginTop: '5px' }} className='d-flex justify-content-between align-items-center'>
    ...
    return <Indicator url="/account/notification" closeNotif={props.closeNotif} openNotif={props.openNotif} dropdown={dropdown} value={customer?.totalNotifReminder || undefined} icon={<NotificationIcon style={{ width: '20px' }} />} />
}
