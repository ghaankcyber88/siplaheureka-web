                ...
                <div className="form-row">
                    {profitUsing.items.map((item, index) => (
                        <div className="col-6 col-sm-3 col-md-2 mb-2">
                            <div style={{background:'linear-gradient(270deg, rgb(0, 183, 240) 30%, rgb(0, 130, 186) 100%)',height:'205px',borderRadius:'20px',paddingBottom:'5px'}} className='text-center text-white p-3'>
                                <LazyLoadImage
                                    alt={item.title}
                                    effect="opacity"
                                    src={item.icon}
